 ...
 * @since 1.0.0
 */
object LimeSkinStyle {
    val STATUS_COLOR = Color.parseColor("#AFB42B")
    val COLOR_FRAME_BG = Color.parseColor("#CDDC39")
    val COLOR_FRAME_TEXT_COLOR = Color.parseColor("#FFFFFF")
    val COLOR_FRAME_SECOND_TEXT_COLOR = Color.parseColor("#F0F4C3")
    val WHITE_FRAME_TEXT_COLOR = Color.parseColor("#212121")
    val WHITE_FRAME_SECOND_TEXT_COLOR = Color.parseColor("#757575")
    val THEME_TITLE = "Lime"
