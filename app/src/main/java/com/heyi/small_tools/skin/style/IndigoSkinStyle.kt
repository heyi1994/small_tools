 ...
 * @since 1.0.0
 */
object IndigoSkinStyle {
        val STATUS_COLOR = Color.parseColor("#303F9F")
        val COLOR_FRAME_BG = Color.parseColor("#3F51B5")
        val COLOR_FRAME_TEXT_COLOR = Color.parseColor("#FFFFFF")
        val COLOR_FRAME_SECOND_TEXT_COLOR = Color.parseColor("#C5CAE9")
        val WHITE_FRAME_TEXT_COLOR = Color.parseColor("#212121")
        val WHITE_FRAME_SECOND_TEXT_COLOR = Color.parseColor("#757575")
        val THEME_TITLE = "Indigo"
